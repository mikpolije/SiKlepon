...
<div>
    <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white bg-opacity-90">
        <div class="text-bold pb-5">
            ...
            <a href="/admin/action/recipe/{{$getDetailCheckup->id}}/print-recipe" style="float: right;" class="btn-shadow bg-cyan-500 text-white rounded px-10 py-2 mb-5 hover:bg-cyan-600">Cetak Resep</a>
        </div>
